...
export class StateMachine {
  constructor() {
    ...
    this.transitions = {
      ...
      [GAME_STATES.MENU]: [GAME_STATES.PLAYING, GAME_STATES.VIEWER, GAME_STATES.ROGUELIKE_ARENA],
      [GAME_STATES.VIEWER]: [GAME_STATES.MENU, GAME_STATES.ROGUELIKE_ARENA],
      ...
      [GAME_STATES.ROGUELIKE_ARENA]: [GAME_STATES.MENU, GAME_STATES.GAMEOVER]
    };
